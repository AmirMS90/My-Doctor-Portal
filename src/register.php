...
<head>
    ...
    <title>Doctors Portal: Register</title>
</head>
...
<body class="dark:bg-slate-900 dark:text-slate-400">
    ...
    <div class="flex h-screen justify-center">
        <form action="./register.php" method="post" class="flex flex-col self-center">
            <h1 class="self-center text-3xl font-extrabold m-4 text-green-400">Register</h1>
            <input name="name" autofocus autocomplete="off" placeholder="Fullname" class="m-2 rounded-md p-1 w-96 text-black border border-black dark:border-0">
            ...
            <input type="password" name="passwordRepeat" placeholder="Password Repeat" class="m-2 rounded-md p-1 w-96 text-black border border-black dark:border-0">
            <input type="submit" value="Register" class="hover:cursor-pointer m-2 rounded-md p-2 w-fit self-center border-2 border-black dark:border-green-950 bg-green-400 dark:text-green-950 hover:-translate-y-1 hover:opacity-90 transition-all">
        </form>
    </div>
</body>
